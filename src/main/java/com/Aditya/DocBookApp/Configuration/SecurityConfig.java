...
import com.Aditya.DocBookApp.Security.JwtAuthenticationFilter;
import com.Aditya.DocBookApp.Security.OAuth2SuccessHandler;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/doctors/{doctorId}").permitAll()
                        .requestMatchers("/api/doctors").permitAll()
                        .requestMatchers("/api/doctors/*/slots").permitAll()
                        .requestMatchers("/api/doctors/*/reviews").permitAll()
